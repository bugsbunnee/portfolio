        ...
        <Card className='p-3 me-3'>
            <Image
                ...
                className={classNames({
                    'w-100 h-64 object-cover rounded-lg': true,
            ...
            <Box>
                ...
                <Text size={{ initial: '1', md: '2' }} className='mt-8'>
                    This app allows hospitals request medical consumables and track delivery in realtime
                </Text>
            </Box>
                
            <Button onClick={() => router.push(project.url)} disabled={project.isConfidential} className='mt-4 w-full bg-fuchsia-600 disabled:bg-gray-200 disabled:text-gray-900' size='3' radius='small'>
